...
<body>
    ...
    <div class="AddEditIFrame" style="width:1000px; height:260px;">
        ...
        <tr>
                <td>
                    ...
                    <ccJSIM:OpenIFrameLinkButton ID="btnAddEditPerson" runat="server" CssClass="Button" 
                     FrameSrc="AddEditTaker.aspx?mode=edit" HeightPosition="219" 
                     IFrameName="ifAddEditUser" LeftPosition="80" Text="Edit User" TopPosition="80" 
