...
Partial Public Class Institution_9
    ...
    '''<summary>
    '''rbCheckInstitution control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rbCheckInstitution As Global.JSIM.Custom_Controls.RadioButtonGridView
End Class
