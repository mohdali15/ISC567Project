<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ManagePerson.aspx.vb" Inherits="ISC567_Spring2013.ManagePerson" %>
...
<body>
    ...
    <div class="ListIFrame">
        <table>
            <tr>
                <td>
                    <ccJSIM:DragIFrame ID="lblHeader" runat="server" Text="Manage Person" CssClass="IFrameHeader" Width="100%">
                    </ccJSIM:DragIFrame>
                </td>
                <td style="text-align:right">
                    <ccJSIM:CloseIFrameButton ID="lbtnClose" runat="server" IFrameName="ifManagePerson" Text="[X] Close" />
                </td>
            ...
            <tr>
                <td class="auto-style2">
                    <ccJSIM:OpenIFrameButton ID="btnAddPerson" CssClass="Button" runat="server" FrameSrc="AddEditPerson.aspx"
                        IFrameName="ifAddEditPerson" Text="Add Person" 
            ...
            <tr>
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server">
                        <asp:ListItem>Select Institution</asp:ListItem>
                    </asp:DropDownList>
                     <asp:DropDownList ID="DropDownList2" runat="server">
                        <asp:ListItem>Select Exam Provider</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" BorderStyle="Solid" BorderColor="Black"
                                ...
                                <ccJSIM:OpenIFrameGridView ID="gvPersonList" runat="server" Width="94%" AllowSorting="True"
                                    AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None"
                                    BorderWidth="1px" CellPadding="3" ChangeRowColor="True" DataKeyNames="PersonID" 
                                    FrameSrc="AddEditPerson.aspx" GridDeleteButtonText="" GridEditButtonText=""
                                    GridLines="Horizontal" GridSortColumn="LastName" GridSortDirection="ASC" HeightPosition="257"
                                    HighlighedRowColor="ActiveBorder" IFrameName="ifAddEditPerson" IncludeSorting="True" 
