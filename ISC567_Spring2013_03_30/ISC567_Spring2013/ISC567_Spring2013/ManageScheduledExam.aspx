<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ManageScheduledExam.aspx.vb" Inherits="ISC567_Spring2013.ManageScheduledExam" %>
...
<body>
    ...
    <div class="ListIFrame">
        <table>
            <tr>
                <td>
                    <ccJSIM:DragIFrame ID="lblHeader" runat="server" Text="Manage ScheduledExam" CssClass="IFrameHeader" Width="100%">
                    </ccJSIM:DragIFrame>
                </td>
                <td style="text-align:right">
                    <ccJSIM:CloseIFrameButton ID="lbtnClose" runat="server" IFrameName="ifManageScheduledExam" Text="[X] Close" />
                </td>
            ...
            <tr>
                <td colspan="2" class="auto-style2">
                    <ccJSIM:OpenIFrameButton ID="btnAddScheduledExam" CssClass="Button" runat="server" FrameSrc="AddEditScheduledExam.aspx?mode=add"
                        IFrameName="ifAddEditScheduledExam" Text="Add ScheduledExam" 
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" BorderStyle="Solid" BorderColor="Black"
                                ...
                                <ccJSIM:OpenIFrameGridView ID="gvScheduledExamList" runat="server" Width="94%" AllowSorting="True"
                                    AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None"
                                    BorderWidth="1px" CellPadding="3" ChangeRowColor="True" DataKeyNames="ScheduledExamID" 
                                    FrameSrc="AddEditScheduledExam.aspx" GridDeleteButtonText="" GridEditButtonText=""
                                    GridLines="Horizontal" GridSortColumn="LastName" GridSortDirection="ASC" HeightPosition="257"
                                    HighlighedRowColor="ActiveBorder" IFrameName="ifAddEditScheduledExam" IncludeSorting="True" 
